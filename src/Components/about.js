...
const classes = useStyles();
    ...
    <Row md={4} style={{marginLeft:"0px"}}>
        ...
        <div style={{marginTop:"auto",marginBottom:"auto",color:"White",fontFamily:"Segoe UI",fontSize:"38px",fontWeight:"lighter",display:"flex"} }>
            <h1 onClick="loadInItems()" style={{fontFamily:"Segoe UI",fontSize:"30px",fontWeight:"lighter",marginLeft:"auto"}}>About</h1>
        ...
        <div className={classes.heroContent}>
          <Container maxWidth="sm">
            ...
            <Typography variant="h5" align="center" color="textSecondary" paragraph>
              This WebApp allows you to manage the places that monitor the social distancing violations made by people. 
              It also allows you to view interesting analytics about the violations data recieved.
            </Typography>
            <div className={classes.heroButtons}>
              <Grid container spacing={2} justify="center">
                <Grid item>
                  <Button variant="contained" style={{backgroundColor:"#fd8708",color:"white"}}>
                    Developed by
                  </Button>
                </Grid>
              </Grid>

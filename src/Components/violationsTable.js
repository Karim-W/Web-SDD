...
export default function EnhancedTable(props) {
  ...
  const [VSS, SetVSS] = React.useState([]);
  ...
  return (
    <div className={classes.root}>
        <EnhancedTableToolbar numSelected={selected.length} style={{maxHeight:"50vh"}} />
        <TableContainer>
          <Table
  ...
  function view(item) {
    ...
    History.push({ pathname:"/loc/violation",state:item,locid:props.tr});
  }
